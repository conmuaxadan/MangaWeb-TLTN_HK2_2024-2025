...
const UsersTab = lazy(() => import('../../components/statistics/UsersTab.jsx'));
const MangasTab = lazy(() => import('../../components/statistics/MangasTab.jsx'));
const ViewsTab = lazy(() => import('../../components/statistics/ViewsTab.jsx'));
          ...
          <Suspense fallback={
            ...
            {activeTab === 'views' && (
              <ViewsTab
                ...
                setMangaViewsLimit={setMangaViewsLimit}
              />
            )}
          </Suspense>
        )}
