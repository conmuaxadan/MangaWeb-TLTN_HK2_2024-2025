...
class AuthService {
     ...
     * @returns true nếu liên kết thành công, false nếu thất bại
     */
    async linkLocalAccount(username, email, password) {
                ...
                if (account.linkedAt) {
                    if (typeof account.linkedAt === 'string') {
                        ...
                        try {
                            ...
                            const dateObj = account.linkedAt;
    ...
    async forgotPassword(email) {
        ...
        try {
            ...
            const apiResponse = await identityHttpClient.post('/auth/forgot-password', {email});
    ...
    async resetPassword(email, code, newPassword) {
        ...
        try {
            const apiResponse = await identityHttpClient.post('/auth/reset-password', {
                email,
                code,
                newPassword
            });
