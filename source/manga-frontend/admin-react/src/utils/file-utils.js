 ...
 */
export const getMangaImageUrl = (fileName) => {
    if (!fileName) return getFileUrl("default-manga-cover.jpg");
...
export const getAvatarUrl = (fileName) => {
    if (!fileName) return getFileUrl("default.jpg");
    return getFileUrl(fileName);
};
 ...
 */
export const getMangaPageUrl = (fileName) => {
    if (!fileName) return getFileUrl("default-manga-page.jpg");
    return getFileUrl(fileName);
};
