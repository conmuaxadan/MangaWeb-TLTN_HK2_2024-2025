...
// User Charts
export const NewUsersByDayChart: React.FC<{
...
export const UsersByAuthProviderChart: React.FC<{
...
export const MostViewedMangaChart: React.FC<{
...
export const ViewsByMangaChart: React.FC<{
    ...
    startDate: string;
    endDate: string;
}> = React.memo(({data, limit, setLimit}) => {
    const limitSelector = (
        <div className="flex items-center space-x-2">
            <FontAwesomeIcon icon={faChartLine} className="text-gray-500 dark:text-gray-400"/>
            <select
