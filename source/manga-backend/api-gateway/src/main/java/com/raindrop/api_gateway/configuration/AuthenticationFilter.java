...
public class AuthenticationFilter implements GlobalFilter, Ordered {
    ...
    String[] publicEndpoints = {
            ...
            "/profile/comments/byChapter/{chapterId}",
            "/profile/comments/count/manga/{mangaId}",
            "/profile/comments/byManga/{mangaId}/count",
            "/profile/comments/latest",
            "/profile/anonymousReadingHistories",
            "/profile/anonymousReadingHistories/bySession/{sessionId}",
            "/profile/anonymousReadingHistories/sessions/{sessionId}/histories",
            "/upload/files",
